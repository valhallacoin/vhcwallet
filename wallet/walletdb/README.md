...
Package walletdb provides a namespaced database interface for vhcwallet.
...
[![GoDoc](https://godoc.org/github.com/valhallacoin/vhcwallet/wallet/walletdb?status.png)](http://godoc.org/github.com/valhallacoin/vhcwallet/wallet/walletdb)

Full `go doc` style documentation for the project can be viewed online without
installing this package by using the GoDoc site here:
http://godoc.org/github.com/valhallacoin/vhcwallet/wallet/walletdb

You can also view the documentation locally once the package is installed with
the `godoc` tool by running `godoc -http=":6060"` and pointing your browser to
http://localhost:6060/pkg/github.com/valhallacoin/vhcwallet/wallet/walletdb

## Installation

```bash
$ go get github.com/valhallacoin/vhcwallet/wallet/walletdb
```

## Examples

* [Basic Usage Example](http://godoc.org/github.com/valhallacoin/vhcwallet/wallet/walletdb#example-package--BasicUsage)  
