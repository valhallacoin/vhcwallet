...
const (
	...
	// VhcdConnectedNtfnMethod is the method used for notifications when
	// a wallet server is connected to a chain server.
	VhcdConnectedNtfnMethod = "vhcdconnected"
	...
	// RevocationCreatedNtfnMethod is the method of the vhcwallet
	...
	// TicketPurchasedNtfnMethod is the method of the vhcwallet
	// ticketpurchased notification.
	TicketPurchasedNtfnMethod = "ticketpurchased"

	// VoteCreatedNtfnMethod is the method of the vhcwallet
...
// VhcdConnectedNtfn defines the vhcddconnected JSON-RPC notification.
type VhcdConnectedNtfn struct {
	Connected bool
}

// NewVhcdConnectedNtfn returns a new instance which can be used to issue a
// vhcddconnected JSON-RPC notification.
func NewVhcdConnectedNtfn(connected bool) *VhcdConnectedNtfn {
	return &VhcdConnectedNtfn{
		Connected: connected,
	}
}
...
func init() {
	...
	MustRegisterCmd(VhcdConnectedNtfnMethod, (*VhcdConnectedNtfn)(nil), flags)
