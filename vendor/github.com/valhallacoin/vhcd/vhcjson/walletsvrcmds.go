...
//
// DEPRECATED.  This will be removed in the next major version bump of vhcjson.
...
type SendManyCmd struct {
	FromAccount string
	Amounts     map[string]float64 `jsonrpcusage:"{\"address\":amount,...}"` // In VHC
	MinConf     *int               `jsonrpcdefault:"1"`
	Comment     *string
}
...
// the SignRawTransactionCmd struct.  Contains Valhalla additions.
