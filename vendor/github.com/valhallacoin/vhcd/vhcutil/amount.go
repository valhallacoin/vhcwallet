...
// units, "1eN VHC" is returned, where N is the AmountUnit.
func (u AmountUnit) String() string {
	...
	case AmountAtom:
		return "Atom"
	default:
		return "1e" + strconv.FormatInt(int64(u), 10) + " VHC"
	}
}
...
//
// NewAmount is for specifically for converting VHC to Atoms (atomic units).
...
// See GoDoc for example: http://godoc.org/github.com/valhallacoin/vhcd/vhcutil#example-Amount
...
// useful for services that build on top of Valhalla (for example, calculating
