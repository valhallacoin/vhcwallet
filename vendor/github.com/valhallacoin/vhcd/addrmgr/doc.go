...
/*
Package addrmgr implements concurrency safe Valhalla address manager.

Address Manager Overview

In order maintain the peer-to-peer Valhalla network, there needs to be a source
of addresses to connect to as nodes come and go.  The Valhalla protocol provides
