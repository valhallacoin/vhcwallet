...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/valhallacoin/vhcd/mempool)

Package mempool provides a policy-enforced pool of unmined Valhalla transactions.

A key responsibility of the Valhalla network is mining transactions – regular
...
Since this package does not deal with other Valhalla specifics such as network
...
package for any projects needing the ability create an in-memory pool of Valhalla
...
```bash
$ go get -u github.com/valhallacoin/vhcd/mempool
```
