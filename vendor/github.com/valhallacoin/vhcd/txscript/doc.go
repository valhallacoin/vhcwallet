...
/*
Package txscript implements the Valhalla transaction script language.

This package provides data structures and functions to parse and execute
valhallacoin transaction scripts.

Script Overview

Valhalla transaction scripts are written in a stack-base, FORTH-like language.

The Valhalla script language consists of a number of opcodes which fall into
...
The vast majority of Valhalla scripts at the time of this writing are of several
...
what conditions must be met in order to spend valhallacoins.
