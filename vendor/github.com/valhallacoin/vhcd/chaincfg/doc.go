...
//
// In addition to the main Valhalla network, which is intended for the transfer
...
// wire.ValhallaNet using ParamsForNet, but be aware that this usage is
...
//          addr, err := vhcutil.NewAddressPubKeyHash(pubKeyHash, chainParams)
//          if err != nil {
//                  log.Fatal(err)
//          }
//          fmt.Println(addr)
//  }
//
// If an application does not use one of the three standard Valhalla networks,
