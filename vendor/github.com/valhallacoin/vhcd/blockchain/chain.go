...
// BlockChain provides functions for working with the Valhalla block chain.
...
type BlockChain struct {
	...
	mainchainBlockCache     map[chainhash.Hash]*vhcutil.Block
...
// StakeVersions is a condensed form of a vhcutil.Block that is used to prevent
...
// exceeded.
func (b *BlockChain) addOrphanBlock(block *vhcutil.Block) {
...
func (b *BlockChain) fetchMainChainBlockByNode(node *blockNode) (*vhcutil.Block, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) fetchBlockByNode(node *blockNode) (*vhcutil.Block, error) {
...
func (b *BlockChain) pushMainChainBlockCache(block *vhcutil.Block) {
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBlock(node *blockNode, block, parent *vhcutil.Block, view *UtxoViewpoint, stxos []spentTxOut) error {
	...
	blockAndParent := []*vhcutil.Block{block, parent}
...
func (b *BlockChain) dropMainChainBlockCache(block *vhcutil.Block) {
	curHash := block.Hash()
	b.mainchainBlockCacheLock.Lock()
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) disconnectBlock(node *blockNode, block, parent *vhcutil.Block, view *UtxoViewpoint) error {
...
func countSpentRegularOutputs(block *vhcutil.Block) int {
...
func countSpentStakeOutputs(block *vhcutil.Block) int {
	var numSpent int
...
func countSpentOutputs(block *vhcutil.Block) int {
...
func (b *BlockChain) reorganizeChainInternal(targetTip *blockNode) error {
	...
	var nextBlockToDetach *vhcutil.Block
	...
	var prevBlockAttached *vhcutil.Block
...
//
// This function MUST be called with the chain state lock held (for writes).
func (b *BlockChain) connectBestChain(node *blockNode, block, parent *vhcutil.Block, flags BehaviorFlags) (int64, error) {
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHash(hash *chainhash.Hash) (*vhcutil.Block, error) {
	node := b.index.LookupNode(hash)
...
//
// This function is safe for concurrent access.
func (b *BlockChain) BlockByHeight(height int64) (*vhcutil.Block, error) {
...
type IndexManager interface {
	...
	// main chain.
	ConnectBlock(database.Tx, *vhcutil.Block, *vhcutil.Block, *UtxoViewpoint) error

	// DisconnectBlock is invoked when a block has been disconnected from
	// the main chain.
	DisconnectBlock(database.Tx, *vhcutil.Block, *vhcutil.Block, *UtxoViewpoint) error
}
...
func New(config *Config) (*BlockChain, error) {
	...
	b := BlockChain{
		...
		mainchainBlockCache:           make(map[chainhash.Hash]*vhcutil.Block),
