...
func (idx *ExistsAddrIndex) ExistsAddress(addr vhcutil.Address) (bool, error) {
...
func (idx *ExistsAddrIndex) ExistsAddresses(addrs []vhcutil.Address) ([]bool, error) {
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) ConnectBlock(dbTx database.Tx, block, parent *vhcutil.Block, view *blockchain.UtxoViewpoint) error {
	...
	blockTxns := make([]*vhcutil.Tx, 0, len(block.Transactions())+
...
//
// This is part of the Indexer interface.
func (idx *ExistsAddrIndex) DisconnectBlock(dbTx database.Tx, block, parent *vhcutil.Block, view *blockchain.UtxoViewpoint) error {
