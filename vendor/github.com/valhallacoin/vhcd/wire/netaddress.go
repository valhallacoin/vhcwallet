...
// maxNetAddressPayload returns the max payload size for a Valhalla NetAddress
...
type NetAddress struct {
	...
	// not present in the Valhalla version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Valhalla protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Valhalla protocol mixes little and big endian.
