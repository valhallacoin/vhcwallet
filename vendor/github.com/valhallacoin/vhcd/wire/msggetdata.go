...
// MsgGetData implements the Message interface and represents a valhallacoin
...
// NewMsgGetData returns a new Valhalla getdata message that conforms to the
...
// NewMsgGetDataSizeHint returns a new Valhalla getdata message that conforms to
