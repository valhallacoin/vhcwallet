...
// MsgGetHeaders implements the Message interface and represents a valhallacoin
...
// NewMsgGetHeaders returns a new Valhalla getheaders message that conforms to
