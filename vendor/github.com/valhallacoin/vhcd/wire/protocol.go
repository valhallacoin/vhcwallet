...
// ServiceFlag identifies services supported by a Valhalla peer.
...
// CurrencyNet represents which Valhalla network a message belongs to.
type CurrencyNet uint32

// Constants used to indicate the message Valhalla network.  They can also be
