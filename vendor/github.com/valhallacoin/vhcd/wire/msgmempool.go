...
// MsgMemPool implements the Message interface and represents a Valhalla mempool
...
// NewMsgMemPool returns a new Valhalla pong message that conforms to the Message
