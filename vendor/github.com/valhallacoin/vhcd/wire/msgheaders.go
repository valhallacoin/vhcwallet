...
// a single Valhalla headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a Valhalla headers
...
// NewMsgHeaders returns a new Valhalla headers message that conforms to the
