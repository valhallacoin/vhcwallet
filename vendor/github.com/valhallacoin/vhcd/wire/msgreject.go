...
// MsgReject implements the Message interface and represents a Valhalla reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the Valhalla protocol does not enforce a sane
...
// NewMsgReject returns a new Valhalla reject message that conforms to the
