...
const DefaultUserAgent = "/vhcwire:0.3.0/"

// MsgVersion implements the Message interface and represents a Valhalla version
...
// NewMsgVersion returns a new Valhalla version message that conforms to the
...
// and local address from conn and returns a new Valhalla version message that
