...
// MsgGetBlocks implements the Message interface and represents a valhallacoin
...
// NewMsgGetBlocks returns a new Valhalla getblocks message that conforms to the
