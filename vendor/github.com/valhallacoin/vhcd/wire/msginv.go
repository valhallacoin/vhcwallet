...
// MsgInv implements the Message interface and represents a Valhalla inv message.
...
// NewMsgInv returns a new Valhalla inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Valhalla inv message that conforms to the
