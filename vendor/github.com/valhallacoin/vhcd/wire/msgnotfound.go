...
// MsgNotFound defines a Valhalla notfound message which is sent in response to
...
// NewMsgNotFound returns a new Valhalla notfound message that conforms to the
