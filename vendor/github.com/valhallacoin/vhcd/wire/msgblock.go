...
// MsgBlock implements the Message interface and represents a valhallacoin
...
// BtcDecode decodes from the Valhalla wire protocol as it was sent across the
...
// the Valhalla wire protocol in order to be sent across the network.  The wire
...
// NewMsgBlock returns a new Valhalla block message that conforms to the
