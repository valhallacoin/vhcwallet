...
// BlockHeader defines information about a block and is used in the valhallacoin
...
// readBlockHeader reads a Valhalla block header from r.  See Deserialize for
...
// writeBlockHeader writes a Valhalla block header to w.  See Serialize for
